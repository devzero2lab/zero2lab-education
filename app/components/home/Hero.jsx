...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-clip h-[67vh]  [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] py-16">
      <div className="container mx-auto px-4 flex flex-col items-end text-center">
        <div className="absolute left-0 w-8/12 h-full flex flex-col items-start mt-32 top-10   z-40    px-28 py-7 rounded-lg">
        ...
        <div className="absolute left-28 top-28 inline-flex items-center shadow-white/20 bg-gradient-to-r from-blue-700 to-purple-700 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow">
          <BookOpenText className="mr-2 h-5 w-5" />
        ...
        <div className="relative   ">
          ...
          <div className="absolute  inset-0 flex justify-center items-center ">
            <motion.div
              className="absolute z-20 h-[544px] w-[544px] rounded-full border-2 border-dashed border-gray-700"
              variants={iconVariants}
              animate="animate"
            >

              {/* Icon 1 */}
              <div className="absolute w-12 h-12 shadow-white/50 rounded-full bg-white shadow-md flex justify-center items-center top-0 left-1/2 transform -translate-x-1/2">
                <Image src="/images/homepage/python.svg" alt="Python" width={32} height={32} />
              </div>


              {/* Icon 2 */}
              <div className="absolute w-12 h-12 shadow-white/50 rounded-full bg-white shadow-md flex justify-center items-center right-0 top-1/2 transform -translate-y-1/2">
